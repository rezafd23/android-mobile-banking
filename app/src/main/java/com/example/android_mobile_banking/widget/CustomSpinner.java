...
public class CustomSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {

    public static final int DEFAULT_ARROW_WIDTH_DP = 18;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setBackgroundTintList(getResources().getColorStateList(R.color.white));
    }
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        baseColor=context.getResources().getColor(R.color.black);
        int defaultBaseColor = context.getResources().getColor(R.color.black);
        int defaultHighlightColor = defaultArray.getColor(1, 0);
        int defaultErrorColor = context.getResources().getColor(R.color.colorTextError);
        int defaultPlaceholderColor = context.getResources().getColor(R.color.colorDarkGrey);
        int defaultLabelColor = context.getResources().getColor(R.color.dark_blue);
        ...
        hintColor = array.getColor(R.styleable.MaterialSpinner_ms_hintColor, defaultPlaceholderColor);
        ...
        floatingLabelColor = array.getColor(R.styleable.MaterialSpinner_ms_floatingLabelColor, defaultLabelColor);
        ...
        mDrawable = getResources().getDrawable(R.drawable.ic_arrow_down);
    ...
    private void initPaintObjects() {
        ...
        int labelTextSize = getResources().getDimensionPixelSize(R.dimen.text_xs_12);
    ...
    private void initDimensions() {
        underlineTopSpacing = getResources().getDimensionPixelSize(R.dimen.default_margin);
        underlineBottomSpacing = getResources().getDimensionPixelSize(R.dimen.pad_5);
        floatingLabelTopSpacing = getResources().getDimensionPixelSize(R.dimen.pad_5);
        floatingLabelBottomSpacing = getResources().getDimensionPixelSize(R.dimen.default_margin);
        rightLeftSpinnerPadding = alignLabels ? getResources().getDimensionPixelSize(R.dimen.default_margin) : 0;
        floatingLabelInsideSpacing = getResources().getDimensionPixelSize(R.dimen.pad_12);
        errorLabelSpacing = (int) getResources().getDimension(R.dimen.pad_12);
        minContentHeight = (int) getResources().getDimension(R.dimen.pad_20);
    }
    ...
    private void drawSelector(Canvas canvas, int posX, int posY) {
        ...
        canvas.drawBitmap(bitmap, posX - bitmap.getWidth(), posY-10, paint);
    }
    ...
    public boolean performClick()
    {
        ...
        try
        {
            ...
            if (listview != null) {
                Log.d("OkHttp", "ada " + listview.getAdapter());
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB)
            {
                ...
                mVerticalScrollbarPositionField.setAccessible(false);
    ...
    private class HintAdapter extends BaseAdapter {
        ...
        public View getDropDownView(int position, View convertView, ViewGroup parent) {
            ...
            if (getItemViewType(position) == HINT_TYPE){
                ...
                v = buildView(position, convertView, parent, true);
            }
        ...
        private View getHintView(final View convertView, final ViewGroup parent, final boolean isDropDownView) {
            ...
            textView.setTextColor(CustomSpinner.this.isEnabled() ? hintColor : disabledColor);
